...
export const ACTION_SUGGESTIONS: ActionSuggestion[] = [
  ...
  { priority: "high", category: "Appel d'offre", title: "Récupérer le CDC réel — AO CNPS", desc: "Seul appel d'offre du portefeuille avec une échéance encore valide (30/07/2026, dans 15 jours). Aucun cahier des charges ingéré à ce jour.", cta: "Voir l'appel d'offre", view: "tenders" },
